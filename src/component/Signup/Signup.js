...
const SignUp = () => {
    ...
    const registerSubmit = (e) => {
        ...
        console.log('student');
        axios.post(`http://127.0.0.1:8000/api/studentregister`, data).then(res => {
            ...
            if (res.data.status === 200) {
                ...
                console.log("looix  name nef", res.data.validation_errors.name);
                setRegister({ ...regiserInput, error_list: res.data.validation_errors });
    ...
    return (
			<div>
				...
				<div>
					<h1>{regiserInput.address}</h1>
					<h1>{regiserInput.name}</h1>
					<h1>{regiserInput.email}</h1>
					<h1>{regiserInput.password}</h1>
					<h1>{regiserInput.confirm}</h1>
					<h1>{regiserInput.option}</h1>
				</div>
