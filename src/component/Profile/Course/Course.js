                      ...
                      <div className="tabs__content py-30 px-30 js-tabs-content">
                        <div className="tabs__pane -tab-item-1 is-active">
                          ...
                          <div className="row y-gap-30 pt-30">
                              ...
                              <div className="pt-15">
                                <div className="d-flex y-gap-10 justify-between items-center">
                                  ...
                                  <div className="d-flex items-center">
                                    <div className="text-14 lh-1 text-yellow-1 mr-10">Online</div>
                                  </div>
                                </div>
                                ...
                                <button className="button btn-1 -purple-1 text-white">See more</button>
                            ...
                            <div className="w-1/5 xl:w-1/3 lg:w-1/2 sm:w-1/1">
                              <div className="relative">
                                <img className="rounded-8 w-1/1" src="img/coursesCards/9.png" alt="image" />
                              </div>
                              <div className="pt-15">
                                <div className="d-flex y-gap-10 justify-between items-center">
                                  <div className="text-14 lh-1">Ali Tufan</div>
                            ...
                            <div className="w-1/5 xl:w-1/3 lg:w-1/2 sm:w-1/1">
                              <div className="relative">
                                <img className="rounded-8 w-1/1" src="img/coursesCards/10.png" alt="image" />
                              </div>
                              <div className="pt-15">
                                <div className="d-flex y-gap-10 justify-between items-center">
                                  <div className="text-14 lh-1">Ali Tufan</div>
                            ...
                            <div className="w-1/5 xl:w-1/3 lg:w-1/2 sm:w-1/1">
                              <div className="relative">
                                <img className="rounded-8 w-1/1" src="img/coursesCards/11.png" alt="image" />
                              </div>
                              <div className="pt-15">
                                <div className="d-flex y-gap-10 justify-between items-center">
                                  <div className="text-14 lh-1">Ali Tufan</div>
